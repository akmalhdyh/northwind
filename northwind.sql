...
ALTER TABLE `orderdetails`
  ...
  ADD KEY `ordersorderdetails` (`orderid`),
  ADD KEY `productid` (`productid`),
  ADD KEY `productsorderdetails` (`productid`);
...
ALTER TABLE `orders`
  ...
  ADD KEY `shippersorders` (`shipperid`);
...
--
ALTER TABLE `orderdetails`
  ADD CONSTRAINT `orderdetails_orderid_orders_orderid` FOREIGN KEY (`orderid`) REFERENCES `orders` (`orderid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `orderdetails_productid_products_productid` FOREIGN KEY (`productid`) REFERENCES `products` (`productid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_customerid_customers_customerid` FOREIGN KEY (`customerid`) REFERENCES `customers` (`customerid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `orders_employeeid_employees_employeeid` FOREIGN KEY (`employeeid`) REFERENCES `employees` (`employeeid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `orders_shipperid_shippers_shipperid` FOREIGN KEY (`shipperid`) REFERENCES `shippers` (`shipperid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `products`
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_categoryid_categories_categoryid` FOREIGN KEY (`categoryid`) REFERENCES `categories` (`categoryid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `products_supplierid_suppliers_supplierid` FOREIGN KEY (`supplierid`) REFERENCES `suppliers` (`supplierid`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
